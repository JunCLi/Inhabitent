...
if ( ! function_exists( 'demo_theme_setup' ) ) :
	...
	function demo_theme_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'demo_theme_custom_background_args', array(
...
function demo_theme_widgets_init() {
	...
	register_sidebar(array(
		'name'          => esc_html__( 'Footer-Widget', 'demo-theme' ),
		'id'            => 'sidebar-2',
		'description'   => esc_html__( 'Add widgets to footer here', 'demo-theme' ),
