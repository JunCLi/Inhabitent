 ...
 * @author    kevinjcli@hotmail.com
 * @license   GPL-2.0+
 * @link      http://example.com
 * @copyright 2019 Jun C Li
 *
 * @wordpress-plugin
...
class Business_Hours extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$mon_to_fri = empty( $instance['mon-to-fri'] ) ? '' : apply_filters( 'mon-to-fri', $instance['mon-to-fri'] );
	...
	public function update( $new_instance, $old_instance ) {
		...
		$instance['mon-to-fri'] = strip_tags( $new_instance['mon-to-fri'] );
	...
	public function form( $instance ) {
		...
		$mon_to_fri = strip_tags( $instance['mon-to-fri'] );
